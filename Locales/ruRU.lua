...
L["%s interrupted %s using %s"] = "%s прервал %s с помощью %s";
L["%s +%s is completed"] = "%s +%s пройдено";
L["%s +%s is reset"] = "%s +%s сброшено";
L["%s +%s is started"] = "%s +%s начато";
L["%s's cast %s is passed"] = "%s успешно завершил чтение способности %s";
L["Close"] = "Закрыть";
L["Date"] = "Дата";
L["Time"] = "Время";
L["Version"] = "Версия";
...
L["Special Buffs Or Debuffs"] = "Особые бафы и дебафы";
L["Casts"] = "Способности";
...
L["Item"] = "Предмет";
L["%s dispelled %s using %s"] = "%s снял %s используя %s";
...
L["MyDungeonsBook %s Dispelled:"] = "MyDungeonsBook Снято %s:";
