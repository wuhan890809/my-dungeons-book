...
function MyDungeonsBook:AllDebuffsOnPartyMemberFrame_GetHeadersForTable(challengeId)
...
function MyDungeonsBook:AllDebuffsOnPartyMemberFrame_Update(challengeId)
    ...
    if (challenge) then
        ...
        self.challengeDetailsFrame.mechanicsFrame.effectsAndAurasFrame.allDebuffsOnPartyMembersFrame.table:SetDisplayCols(self:AllDebuffsOnPartyMemberFrame_GetHeadersForTable(challengeId));
