...
function MyDungeonsBook:AllBuffsOnPartyMemberFrame_Update(challengeId)
    ...
    if (challenge) then
        ...
        self.challengeDetailsFrame.mechanicsFrame.effectsAndAurasFrame.allBuffsOnPartyMembersFrame.table:SetDisplayCols(self:AllBuffsOnPartyMemberFrame_GetHeadersForTable(challengeId));
