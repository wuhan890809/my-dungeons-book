...
function MyDungeonsBook:FriendlyFireFrame_CreateTabButtonsFrame(parentFrame, challengeId)
    ...
    tabs:SetCallback("OnGroupSelected", function (container, _, tabId)
        ...
        self:FriendlyFireByPartyMemberFrame_Create(container, self.activeChallengeId, tabId);
    end);
    tabs:SetHeight(550);
    return tabs;
end
